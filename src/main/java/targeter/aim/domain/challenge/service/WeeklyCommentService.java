...
public class WeeklyCommentService {
    ...
    private final WeeklyCommentQueryRepository weeklyCommentQueryRepository;
    ...
    public WeeklyCommentDto.WeeklyCommentPageResponse getWeeklyComments(
        ...
        Page<WeeklyCommentDto.WeeklyCommentResponse> pageResult = weeklyCommentQueryRepository.paginateByChallengeIdAndWeeksId(challengeId, weeksId, pageable);

        return WeeklyCommentDto.WeeklyCommentPageResponse.from(pageResult);
    }
}